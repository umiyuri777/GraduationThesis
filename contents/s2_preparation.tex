...
オープンワールドゲームとは，広大かつ連続的な探索可能領域を持つビデオゲームのジャンルを指す．最大の特徴は，個別の場面ごとにマップが分断されることなく，すべての領域がシームレスに接続されている点である\cite{sca_openworld}．従来のゲームにおいて一般的であったエリア移動時のロード画面が排除されており，プレイヤは広大なフィールドを途切れなく自由に移動することが可能である．

また，ゲーム進行における自由度の高さも重要な要素である．開発者によって進行順序が固定されている従来の線形なゲーム形式とは異なり，オープンワールドゲームは非線形な構造を持つ．具体的には，目的地へ到達するための経路選択や，ゲーム内で提示されるタスクやクエストを消化する順序を，プレイヤ自身の判断で任意に決定できる場合が多い\cite{sca_openworld}．プレイヤは物理的な制約を除いてフィールド上を自由に探索することができる．
