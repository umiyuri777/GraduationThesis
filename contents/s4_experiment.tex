...
\begin{figure}[H]
    \begin{center}
        \includegraphics[height=200mm]{img/test_method_2.png}
        \caption{実験の概要図}
        \label{fig:testflow}
    \end{center}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[height=100mm]{img/stack.png}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[height=100mm]{img/player.png}
        \caption{プレイヤキャラクタ}
        \label{fig:player}
    \end{center}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[height=100mm]{img/star.png}
        \caption{星のオブジェクト}
        \label{fig:star}
    \end{center}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[height=100mm]{img/tree.png}
        \caption{木のオブジェクト}
        \label{fig:tree}
    \end{center}
\end{figure}
