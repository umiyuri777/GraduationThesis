...
\begin{figure}[H]
    \begin{center}
        \includegraphics[height=0.95\textheight, keepaspectratio]{img/test_method_2.png}
        \caption{実験の概要図}
        \label{fig:testflow}
    \end{center}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \begin{subfigure}[b]{0.4\textwidth}
    \includegraphics[width=\textwidth]{img/stack.png}
  ...
  \caption{StarColectionに配置されているオブジェクト}
\end{figure}

% \begin{figure}[tb]
%     \begin{center}
%         \includegraphics[width=80mm]{img/stack.png}
%         \caption{スタックする不具合を模したオブジェクト}
%         \label{fig:stack_bug_object}
%     \end{center}
% \end{figure}
...
% \begin{figure}[tb]
%     \begin{center}
%         \includegraphics[width=80mm]{img/player.png}
%         \caption{プレイヤキャラクタ}
%         \label{fig:player}
%     \end{center}
% \end{figure}
...
% \begin{figure}[tb]
%     \begin{center}
%         \includegraphics[width=80mm]{img/star.png}
%         \caption{星のオブジェクト}
%         \label{fig:star}
%     \end{center}
% \end{figure}
...
% \begin{figure}[tb]
%     \begin{center}
%         \includegraphics[width=80mm]{img/tree.png}
%         \caption{木のオブジェクト}
%         \label{fig:tree}
%     \end{center}
% \end{figure}
