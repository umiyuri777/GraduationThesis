...
\cref{chap:test2}においては，ベースラインと比較して予測性能の向上は見られなかった．この要因として，実験データの偏りが挙げられる．\cref本実験で収集したデータにおいて，不具合を発見できたテストケースは全体の約84\%を占めていた．このように正例の割合が極めて高い不均衡なデータセットであったため，学習されたモデルは特徴量に関わらず「不具合発見」と予測する傾向が強まり，すべてを正と予測するベースライン手法と差異が生じなかったことに起因すると考えられる．
